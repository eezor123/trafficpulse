...
export const DEFAULT_PROXIES: ProxyNode[] = [
  // North America - Canada (Rogers, Bell, Telus, Shaw, Vidéotron Residential Nodes)
  ...
  { id: 'prx_ca_2', protocol: 'http', host: '24.200.115.82', port: 8080, countryCode: 'CA', countryName: 'Canada', flag: '🇨🇦', countryFlag: '🇨🇦', region: 'North America', city: 'Vancouver, BC', isp: 'Telus Communications', asn: 'AS852', status: 'active', latencyMs: 48, realExitIp: '24.200.115.82', exitIp: '24.200.115.82', proxyType: 'residential', enabled: true, rotationType: 'sticky' },
  { id: 'prx_ca_3', protocol: 'http', host: '70.24.188.42', port: 8080, countryCode: 'CA', countryName: 'Canada', flag: '🇨🇦', countryFlag: '🇨🇦', region: 'North America', city: 'Montreal, QC', isp: 'Bell Canada Fibe', asn: 'AS577', status: 'active', latencyMs: 45, realExitIp: '70.24.188.42', exitIp: '70.24.188.42', proxyType: 'residential', enabled: true, rotationType: 'sticky' },
  { id: 'prx_ca_4', protocol: 'http', host: '99.230.14.77', port: 8080, countryCode: 'CA', countryName: 'Canada', flag: '🇨🇦', countryFlag: '🇨🇦', region: 'North America', city: 'Calgary, AB', isp: 'Shaw Communications (Rogers)', asn: 'AS6327', status: 'active', latencyMs: 50, realExitIp: '99.230.14.77', exitIp: '99.230.14.77', proxyType: 'residential', enabled: true, rotationType: 'sticky' },
  { id: 'prx_ca_5', protocol: 'http', host: '142.112.90.31', port: 8080, countryCode: 'CA', countryName: 'Canada', flag: '🇨🇦', countryFlag: '🇨🇦', region: 'North America', city: 'Ottawa, ON', isp: 'Rogers Cable Residential', asn: 'AS812', status: 'active', latencyMs: 49, realExitIp: '142.112.90.31', exitIp: '142.112.90.31', proxyType: 'residential', enabled: true, rotationType: 'sticky' },
  { id: 'prx_ca_6', protocol: 'http', host: '174.112.55.19', port: 8080, countryCode: 'CA', countryName: 'Canada', flag: '🇨🇦', countryFlag: '🇨🇦', region: 'North America', city: 'Edmonton, AB', isp: 'Telus PureFibre', asn: 'AS852', status: 'active', latencyMs: 53, realExitIp: '174.112.55.19', exitIp: '174.112.55.19', proxyType: 'residential', enabled: true, rotationType: 'sticky' },
  { id: 'prx_ca_7', protocol: 'http', host: '198.53.110.88', port: 8080, countryCode: 'CA', countryName: 'Canada', flag: '🇨🇦', countryFlag: '🇨🇦', region: 'North America', city: 'Quebec City, QC', isp: 'Vidéotron Ltée', asn: 'AS5769', status: 'active', latencyMs: 47, realExitIp: '198.53.110.88', exitIp: '198.53.110.88', proxyType: 'residential', enabled: true, rotationType: 'sticky' },
  { id: 'prx_ca_8', protocol: 'http', host: '207.161.40.12', port: 8080, countryCode: 'CA', countryName: 'Canada', flag: '🇨🇦', countryFlag: '🇨🇦', region: 'North America', city: 'Halifax, NS', isp: 'Eastlink Residential', asn: 'AS11260', status: 'active', latencyMs: 56, realExitIp: '207.161.40.12', exitIp: '207.161.40.12', proxyType: 'residential', enabled: true, rotationType: 'sticky' },
