...
export const DEFAULT_PROXIES: ProxyNode[] = [
  // North America
  { id: 'prx_us_1', protocol: 'http', host: '198.51.100.42', port: 8080, countryCode: 'US', countryName: 'United States', flag: '🇺🇸', countryFlag: '🇺🇸', region: 'North America', city: 'New York, NY', isp: 'Comcast XFINITY Residential', asn: 'AS7922', status: 'active', latencyMs: 38, realExitIp: '198.51.100.42', exitIp: '198.51.100.42', proxyType: 'residential', enabled: true, rotationType: 'sticky' },
...
export const GLOBAL_COUNTRIES: GeoCountry[] = [
  // ================= NORTH AMERICA =================
  { code: 'US', name: 'United States', flag: '🇺🇸', weight: 35, locale: 'en-US,en;q=0.9', timezone: 'America/New_York', ipSample: '198.51.100.42', region: 'North America', enabled: true, city: 'New York / Los Angeles / Chicago', isp: 'Comcast / AT&T / Verizon', asn: 'AS7922' },
