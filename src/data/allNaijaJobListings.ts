...
export const ALL_VERIFIED_NAIJA_JOBS: NaijaJobListingItem[] = [
  ...
  },
  {
    ...
    categoryName: 'Hospitality & Sales',
    location: 'Lagos (Surulere / Ikeja)',
    salaryRange: '₦80,000 - ₦140,000',
    description: 'Urgent vacancy for an energetic male barbecue grill master and direct sales representative. Responsible for quality meat preparation, customer service, grill station sanitation, and daily cash reconciliation.',
    contactOrEmployer: 'Smoky Grills & Lounge (+2348023456781)',
    category: 'post',
    visitWeight: 99,
  },
  {
    ...
    title: 'Urgent Commercial Solar & Inverter Installation Lead',
    categoryName: 'Solar Energy & Electrical Systems',
    location: 'Rivers (Port Harcourt - Trans-Amadi)',
    salaryRange: '₦750,000 - ₦1,200,000',
    description: 'Certified electrical technician required to oversee 20kVA commercial hybrid inverter and high-voltage lithium battery bank deployment for industrial fabrication warehouse in Port Harcourt.',
    contactOrEmployer: 'Delta Clean Energy Systems',
    category: 'post',
    visitWeight: 98,
  },
  {
    id: 'job_1787164099999',
    path: '/?job=job_1787164099999',
    title: 'Senior Flutter & React Native Mobile App Engineer',
    categoryName: 'Mobile App Development',
    location: 'Lagos (Lekki / Remote)',
    salaryRange: '₦550,000 - ₦800,000',
    description: 'Mobile developer required to build and deploy cross-platform rider dispatch and customer apps with offline data syncing, GPS geofencing, and automated Paystack/Flutterwave in-app topup.',
    contactOrEmployer: 'Naija Logistics Express',
    category: 'post',
    visitWeight: 97,
  },
];
